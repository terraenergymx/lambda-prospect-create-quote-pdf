...
export async function createProspectQuotePdfUseCase(
    ...
    doc.setFontSize(16);
    doc.setTextColor(darkTextColor);
    doc.text("01", (0.50*W), (0.50*H), { align: 'center', baseline: 'middle' });
    doc.text("02", (0.50*W), (0.100*H), { align: 'center', baseline: 'middle' });
    doc.text("03", (0.50*W), (0.150*H), { align: 'center', baseline: 'middle' });
    doc.text("04", (0.50*W), (0.200*H), { align: 'center', baseline: 'middle' });
    doc.text("05", (0.50*W), (0.250*H), { align: 'center', baseline: 'middle' });
    doc.text("06", (0.50*W), (0.300*H), { align: 'center', baseline: 'middle' });
    doc.text("07", (0.100*W), (0.50*H), { align: 'center', baseline: 'middle' });
    doc.text("08", (0.100*W), (0.100*H), { align: 'center', baseline: 'middle' });
    doc.text("09", (0.100*W), (0.150*H), { align: 'center', baseline: 'middle' });
    doc.text("10", (0.100*W), (0.200*H), { align: 'center', baseline: 'middle' });
    doc.text("11", (0.100*W), (0.250*H), { align: 'center', baseline: 'middle' });
    doc.text("12", (0.100*W), (0.300*H), { align: 'center', baseline: 'middle' });
    doc.text("13", (0.150*W), (0.50*H), { align: 'center', baseline: 'middle' });
    doc.text("14", (0.150*W), (0.100*H), { align: 'center', baseline: 'middle' });
    doc.text("15", (0.150*W), (0.150*H), { align: 'center', baseline: 'middle' });
    doc.text("16", (0.150*W), (0.200*H), { align: 'center', baseline: 'middle' });
    doc.text("17", (0.150*W), (0.250*H), { align: 'center', baseline: 'middle' });
    doc.text("18", (0.150*W), (0.300*H), { align: 'center', baseline: 'middle' });
    doc.text("19", (0.200*W), (0.50*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.200*W), (0.100*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.200*W), (0.150*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.200*W), (0.200*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.200*W), (0.250*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.200*W), (0.300*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.250*W), (0.50*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.250*W), (0.150*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.250*W), (0.200*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.250*W), (0.250*H), { align: 'center', baseline: 'middle' });
    doc.text("20", (0.250*W), (0.300*H), { align: 'center', baseline: 'middle' });
